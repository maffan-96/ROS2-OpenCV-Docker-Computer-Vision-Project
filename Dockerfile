...
# RUN mkdir src
# COPY ./OpenCV_video_capture /ros2_ws/src/OpenCV_video_capture
...
# COPY ./OpenCV_video_capture/launch/image_processing.launch.py /ros2_ws/src/OpenCV_video_capture/launch/image_processing.launch.py

# # Set the default launch file
# ENV ROS_DOMAIN_ID=0
# ENV LAUNCH_FILE=/ros2_ws/image_processing.launch

# Start the ROS 2 package and OpenCV in the container
# CMD [ "bash", "-c", "source /ros2_ws/install/setup.bash && ros2 launch OpenCV_video_capture $LAUNCH_FILE" ]
